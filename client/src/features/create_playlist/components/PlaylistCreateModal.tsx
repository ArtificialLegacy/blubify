...
import { PlaylistData } from '../types/playlist_data'
import playlistCreateDataValidationSchema from '../validators/validate_playlist_create_data'
import { playlistGetList, usePlaylistState } from 'features/playlist'
...
function PlaylistCreateModal(_props: playlistCreateModalProps) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (_values) => {
      ...
      setStatus(status)
      if (status === GenericResult.Success) _props.closePlaylistModal()
